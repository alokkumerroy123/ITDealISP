...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/vendors/themify-icons/css/themify-icons.css') }}">
...
<body id="page-top">
    ...
    <script src="//cdn.datatables.net/1.12.1/js/jquery.dataTables.min.js"></script><br><br>
